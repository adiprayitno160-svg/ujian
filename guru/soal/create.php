...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($pertanyaan) || !$id_ujian || !$tipe_soal) {
        ...
        try {
            ...
            error_log("Create soal - Data: ujian_id=$id_ujian, tipe=$tipe_soal, pertanyaan_len=" . $strlen_func($pertanyaan) . ", opsi_json_len=" . ($opsi_json ? $strlen_func($opsi_json) : 0) . ", kunci_len=" . $strlen_func($db_kunci_jawaban));
