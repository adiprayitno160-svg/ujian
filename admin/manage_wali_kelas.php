        ...
        <div class="card-body">
            <form method="POST">
                ...
                <div class="d-flex gap-2">
                    ...
                    <a href="<?php echo base_url('admin/manage_wali_kelas.php'); ?>" class="btn btn-secondary">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="btn-group" role="group">
                                            <a href="<?php echo base_url('admin/manage_wali_kelas.php?edit=' . $wk['id']); ?>" class="btn btn-sm btn-primary">
