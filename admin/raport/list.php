 ...
 * Halaman untuk admin melihat dan mencetak raport siswa
 */
...
$siswa_list = [];
if ($id_kelas) {
    $stmt = $pdo->prepare("SELECT u.id, u.username as nisn, u.nis, u.nama, k.nama_kelas
                          FROM users u
...
// Get penilaian for siswa - hanya yang sudah aktif (diterbitkan)
$penilaian_data = [];
if (!empty($siswa_list)) {
    ...
    <div class="card-body">
        <form method="GET" class="row g-3">
            <div class="col-md-3">
                ...
                $tahun_ajaran_list = $stmt_ta->fetchAll();
                ?>
    ...
    <div class="card border-0 shadow-sm">
        ...
        <div class="card-body">
            ...
            <div class="card-footer">
                <a href="<?php echo base_url('admin/raport/print_kelas.php?id_kelas=' . $id_kelas . '&tahun_ajaran=' . urlencode($tahun_ajaran) . '&semester=' . $semester); ?>" 
